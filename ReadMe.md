...
<ol>
    ...
    <li>
     ...
     <li>
       ...
       <pre>az sql server firewall-rule create --resource-group &ltYour Resource Name&gt --server &ltYour Unique DB Name&gt --name AllowAzureIps --start-ip-address 0.0.0.0 --end-ip-address 0.0.0.0</pre>
