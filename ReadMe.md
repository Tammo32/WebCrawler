...
<ol>
    ...
    <li>
     ...
     <li>
        ...
        This command will create an app service plan to host the project. Replace <pre>Your Resouce Name</pre> and <pre><Your Location></pre> with a researce name and loaction of your choice.
      </div>
    </li>
</ol>
